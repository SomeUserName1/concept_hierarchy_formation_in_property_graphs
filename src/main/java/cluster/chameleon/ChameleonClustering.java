...
public class ChameleonClustering implements Clustering {
package algorithm;
...
import java.util.stream.Collectors;
    ...
    /**
    * TODO adapt to problem. Source: https://github.com/kstanisz/chameleon-clustering
    */
    /*
    public class chameleon {
        ...
        private List<Clustering> clusters = new ArrayList<>(); // List of result clusters
...
/*
        ...
        public List<Clustering> run() {
            ...
            while (clusters.size() < initNrOfClusters) {
                ...
                Clustering clusterToPartition = clusters.stream()
                        .max(Comparator.comparing(c -> c.getPoints().size()))
                        .get();
                List<Clustering> twoClusters = partitionCluster(clusterToPartition);
            ...
            while (clusters.size() > resultNrOfClusters) {
                ...
                List<Clustering> twoClusters = findTwoClustersToConnect();
                Clustering resultCluster = mergeTwoClusters(twoClusters.get(0), twoClusters.get(1));
...
/*
        ...
        private List<Clustering> partitionCluster(Clustering cluster) {
            ...
            Clustering firstCluster = new Clustering();
            ...
            Clustering secondCluster = new Clustering();
...
/*
        ...
        private List<Clustering> findTwoClustersToConnect() {
            Clustering bestFirst = new Clustering();
            Clustering bestSecond = new Clustering();

            double bestConnectionMetrics = Double.MIN_VALUE;
            // For each part of clusters compute connection metrics and find the best pair
            for (Clustering firstCluster : clusters) {
                for (Clustering secondCluster : clusters) {
...
/*
        ...
        private double computeConnectionMetrics(Clustering firstCluster, Clustering secondCluster) {
...
/*
        ...
        private double computeRI(Clustering firstCluster, Clustering secondCluster) {
...
/*
        ...
        private double computeRC(Clustering firstCluster, Clustering secondCluster) {
...
/*
        ...
        private double computeEC(Clustering firstCluster, Clustering secondCluster) {
...
/*
        ...
        private Clustering mergeTwoClusters(Clustering firstCluster, Clustering secondCluster) {
            Clustering resultCluster = new Clustering();
