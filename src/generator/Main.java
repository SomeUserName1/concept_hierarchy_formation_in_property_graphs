...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    SyntheticNodeGenerator sNG = new SyntheticNodeGenerator(width, depth);
    sNG.generate(path + "synthetic");

    sNG.introduce_nose(remLabels, addLabels, alterLabels, probability);
    sNG.generate(path + "synthetic_noisy");
